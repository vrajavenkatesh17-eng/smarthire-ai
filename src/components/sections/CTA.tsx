  ...
  return <section className="py-24 bg-gradient-subtle relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        duration: 0.5
          ...
          duration: 0.5,
          delay: 0.1
        }} className="text-heading md:text-display-sm mb-6 text-[#1d2025]">
          ...
          delay: 0.3
            ...
            scale: 1.02
              ...
              <Input type="email" placeholder="Enter your work email..." value={email} onChange={e => setEmail(e.target.value)} onKeyDown={e => e.key === "Enter" && handleGetStarted()} className="w-full h-12 transition-shadow focus:shadow-lg focus:shadow-primary/10" />
            </motion.div>
            <motion.div whileHover={{
            scale: 1.05
          }} whileTap={{
